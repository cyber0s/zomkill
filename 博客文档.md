...
**下载地址**: [ZomKill v2.0](https://github.com/xinux/zomkill/releases)  
**文件大小**: 约 29MB（包含内置中文字体）
...
想要添加其他功能（如无限阳光、秒杀僵尸等）？

```rust
// 1. 定义内存地址
const INFINITE_SUN_ADDR: u32 = 0x00XXXXXX;

// 2. 实现读取函数
fn read_infinite_sun(&mut self) -> bool {
    // 类似 read_sun_value 的实现
}

// 3. 实现写入函数
fn write_infinite_sun(&mut self, value: i32) -> bool {
    // 类似 write_sun_value 的实现
}
...
- [egui 示例集合](https://www.egui.rs/)
- [eframe 模板项目](https://github.com/emilk/eframe_template)

### Windows API 编程

- [windows-rs 文档](https://docs.rs/windows/)
- [Windows API 官方文档](https://learn.microsoft.com/en-us/windows/win32/)

### 游戏修改技术

- [Cheat Engine 教程](https://www.cheatengine.org/tutorials.php)
- [游戏内存修改原理](https://guidedhacking.com/)
...
1. **Rust 语言特性** - 所有权、生命周期、trait、宏等
2. **Windows API 编程** - 进程、内存、窗口操作
3. **GUI 开发** - egui 即时模式 GUI 的设计理念
4. **游戏修改技术** - 内存分析、指针链、动态修改
5. **跨平台编译** - 在 macOS 上编译 Windows 程序

**Rust 相比 C++ 的优势非常明显：**
- 编译器帮助避免了大量内存错误
- Cargo 极大简化了依赖管理
- 类型系统和 Result 让错误处理更优雅
- 现代化的语法提高了代码可读性

如果你对 Rust 或游戏修改技术感兴趣，欢迎访问我的博客 [www.xinux.top](https://www.xinux.top) 或加 QQ：913499532 交流学习！

**最后再次强调：本程序仅供学习研究，请勿用于非法用途！使用辅助工具可能影响游戏体验，请谨慎使用！**

---

## 📄 开源协议

本项目遵循 MIT 协议开源，仅供学习交流使用。

## 🙏 致谢

- 感谢 Rust 社区提供的优秀工具和库
- 感谢 egui 作者 Emil Ernerfeldt 的杰出工作
- 感谢所有植物大战僵尸玩家的支持
